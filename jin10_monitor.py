...
DEFAULT_KEYWORDS = [
    # --- 地緣政治與衝突 ---
    "伊朗", "以色列", "俄罗斯", "乌克兰", "台湾",
    "制裁", "战争", "军事", "核", "冲突", "关税", "Tariff", "贸易战", "出口管制",
    
    # --- 央行、貨幣政策與流動性 ---
    "美联储", "Fed", "鲍威尔", "Powell", "加息", "降息", "利率", "货币政策",
    "欧央行", "BOJ", "美债", "收益率", "国债",
    "流动性",
    
    # --- 宏觀經濟指標 ---
    "CPI", "PCE", "非农", "就业", "GDP", "通胀", "衰退",
    "大宗", "石油", "原油", "OPEC", "汇率",
    
    # --- 加密貨幣與機構生態 ---
    "比特币", "Bitcoin", "BTC", "以太坊", "ETH", "加密", "crypto", "稳定币",
    "SEC", "CFTC", "ETF", "现货ETF", "贝莱德", "BlackRock", "富达",
    "MicroStrategy", "MSTR", "币安", "Binance", "Coinbase", "Tether", "Circle",
    "爆仓", "清算", "质押", "减半",
    
    # --- 關鍵人物、機構與風險資產 ---
    "特朗普", "Trump", "拜登", "美国", "中国", "世界银行", "IMF", "G7", "G20",
    "巴菲特", "伯克希尔", "BRK", "马斯克", "Musk",
